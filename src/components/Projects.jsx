...
// Project cards with image, description, tech badges, and action links.
  ...
  return (
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden">
        ...
        {/* Featured badge */}
        {project.featured && (
          <span className="absolute top-3 right-3 font-mono text-xs px-2 py-0.5 rounded-full bg-accent/20 text-accent border border-accent/30 backdrop-blur-sm">
            ✦ Featured
          </span>
        )}
      </div>
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <div className="flex flex-wrap gap-1.5 mb-5">
          {project.tech.map((t) => (
            <span
              key={t}
              className="font-mono text-xs px-2 py-0.5 rounded bg-white/5 text-text-secondary border border-white/[0.07]"
            >
              {t}
            </span>
          ))}
